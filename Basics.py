...
# import images and convert from bgr to rgb
...
# display a purple box around identified face
...
# compare faces returns a boolean, true if same person
# find distance between them, lower distance = match
results = face_recognition.compare_faces([encodeElon], encodeTest)
faceDis = face_recognition.face_distance([encodeElon], encodeTest)
print(results,faceDis)

# display results on test image
